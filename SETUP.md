...
Un email individuel qui dépasserait malgré tout ~35 Mo est désormais signalé clairement en fin de traitement (au lieu d'échouer silencieusement) : à transférer manuellement dans ce cas. Plus largement, l'écran final indique maintenant le détail de la dernière erreur rencontrée en cas d'échec.
